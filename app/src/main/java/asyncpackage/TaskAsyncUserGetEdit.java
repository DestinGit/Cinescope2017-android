 ...
 */
public class TaskAsyncUserGetEdit extends AsyncTask<String, Integer, String> {

    private TextView textViewMessage;

    public TaskAsyncUserGetEdit(TextView textViewMessage) {
        super();
    ...
    protected String doInBackground(String... asParametres) {
        ...
        try {
            ...
            params += "&email=" + URLEncoder.encode(asParametres[3], "UTF-8");
    ...
    protected void onPostExecute(String asResultat) {
        ...
        if (asResultat.equalsIgnoreCase("Erreur réseau")) {
            ...
            try {
                ...
                if (tJson.length() > 0) {
                    textViewMessage.setText("Modification OK");

                } else {
                    textViewMessage.setText("Erreur modification");
                }
